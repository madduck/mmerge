[![Style and unit tests badge](https://github.com/madduck/mmerge/actions/workflows/python-package.yml/badge.svg)](https://github.com/madduck/mmerge/actions/workflows/python-package.yml)
...
`mmerge` is © 2026 martin f. krafft <tcboard@pobox.madduck.net>.
